...
public class University {
	...
	void createSchools()
	{
		s[0]= new School("CS","AMIT",240,6);
		s[1]= new School("E&C","VINAY",240,7);
		s[2]=new School("E&E","AVINASH",60,20);
		s[3]=new School("MECH","MANOJ",240,15);
		s[4]=new School("CIVIL","CHETAN",60,10);
	}
	void cal_stud()
	{
